...
namespace Malai.UI.ViewModel
{
    public class WorkedHoursViewModel : ViewModelBase
    {
        ...
        {
            get => Globals.SelectedMonth;
            set
            {
                Globals.SelectedMonth = value;
                LoadAsync();
            }
        }
        public int SelectedYear
        {
            get => Globals.SelectedYear;
            set
            {
                Globals.SelectedYear = value;
                LoadAsync();
            }
        }
        ...
        private void Add(object? parameter)
        {
            ...
            DateTime startDateTime = Assist.RoundToNearest(DateTime.Now, TimeSpan.FromMinutes(10));
